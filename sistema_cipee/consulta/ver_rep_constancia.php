...
$sql = "INSERT INTO PROCESADA (nacion,cedula,nombre,fecha_solicitud,titulo,codigo,tomo,folio,ciudad_r,estado_r,estatus,periodo,year,tramo) 
values ('$row[nacion]','$row[cedula]','$row[nombre]','$fecha','$row[titulo]','$row[codigo]','$row[tomo]','$row[folio]','$row[ciudad_r]','$row[estado_r]','$estado','$row[periodo]','$ano','$row[tramo]');";
...
<table width="625" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <tr> 
    <td height="0" colspan="2"><p align="center"><strong><font size="5" face="Times New Roman, Times, serif">CONSTANCIA DE ESTUDIO</font></strong></p></td>
  </tr>
</table>
 <td>&nbsp;</td> 
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
    <tr> 
    <td height="0" colspan="2"><p align="justify"  style="font: 14pt/20pt Garamond, Georgia, serif;" ><font size="3" face="Times New Roman, Times, serif">&nbsp;&nbsp;   Quien Suscribe,<strong> <? echo $row2[5]; ?>, Titular de la Cédula de identidad <strong> N. V-9990172</strong>, <? echo $row2[7]; ?></strong>, hace constar por medio de la presente, que el Ciudadano(a) <strong> <? echo $row[nombre]; ?></strong>, Titular de la Cédula de identidad N. <strong> <? echo $row[nacion].'-'.$row[cedula]; ?></strong>, Cursa Actualmente el Tramo:<strong> <? echo $row[tramo]; ?></strong> , en esta Casa de Saberes, en el Programa de Formación de Grado: <strong> <? echo $row[titulo]; ?></strong>, para el período académico:  <strong> <? echo $row[periodo]; ?></strong>.</font></p></td>
  </tr>
</table>
...
document.write (dia_mes + " días del mes de " + nombres_meses[mes - 1] + " del año " + anio)
 ...
 <tr> 
    <td height="0" colspan="2"><p align="justify"  style="font: 14pt/20pt Garamond, Georgia, serif;" ><font size="3" face="Times New Roman, Times, serif">&nbsp;&nbsp;   Fecha de Vencimiento: 30 de Noviembre del 2013.</td>
  </tr>
</table>
<p>&nbsp;</p><p>&nbsp;</p>
...
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 <tr> 
   ...
   <tr> 
    <td height="0" colspan="2"><p align="center"><font size="1" face="Times New Roman, Times, serif"><strong>(Según Resolución Nº CD-O-80-04 de fecha 26 de Junio de 2007)
 </font></p></td>
  </tr>
</table>
