...
<table width="824" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td height="0" colspan="2"><p align="left"><strong><font size="4" face="Times New Roman, Times, serif">COMPROBANTE 
        DE RETENCION DEL IMPUESTO SOBRE ACTIVIDADES ECONOMICAS DE INDUSTRIAS, COMERCIO Y SERVICIOS</font></strong></p></td>
  </tr>
  <tr> 
...
echo "<td <font size=1 align=left><small style=width: 50px><b>IMP.%</b></font></td>";
echo "<td <font size=1 align=left><small style=width: 50px><b>TOTAL RETENIDO</b></font></td>";
echo "</tr> ";
...
echo "<td <font size=1><small style=width: 50px>$row[7]</font></td>";
echo "<td <font size=1 align=right><small style=width: 50px>$row[8]</font></td>";
