...
<table width="617" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td height="0" colspan="2"><p align="center"><strong><font size="3" face="Times New Roman, Times, serif">RELACI&Oacute;N 
        DE VIATICOS  (<?php echo $_GET['tipo'];?>)</font></strong></p></td>
  </tr>
  <tr> 
...
cheque.id_cheque,cheque.ncheque,
cheque.fecha,cheque.monto_cheque,
cheque.beneficiario,cheque.cedula_rif,cheque.concepto,
cheque.tipo_f from cheque
inner join distribucion_cheque on cheque.ncheque=distribucion_cheque.ncheque
where
distribucion_cheque.cod_partida='42' AND
cheque.tipo_f='$condicion' AND
cheque.ESTADO='PAGADO' AND
(cheque.fecha >= '$desde' AND cheque.fecha <= '$hasta')
ORDER BY cheque.id_cheque ASC
");
