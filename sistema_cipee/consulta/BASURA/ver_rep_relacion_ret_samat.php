...
<table width="617" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td height="0" colspan="2"><p align="center"><strong><font size="3" face="Times New Roman, Times, serif">RELACION DE RETENCIONES DEL IMPUESTO SOBRE ACTIVIDADES ECONOMICAS DE INDUSTRIAS, COMERCIO Y SERVICIOS(<?php echo $_GET['tipo'];?>)</font></strong></p></td>
  </tr>
  <tr> 
...
from retencion_samat 
inner join cheque on cheque.ncheque=retencion_samat.ncheque	
where
...
echo "<td <font size=1 align=right><small style=width: 50px>$row[7]</font></td>";
echo "<td <font size=1 align=right><small style=width: 50px>$row8</font></td>";

echo "<td <font size=1 align=right><small style=width: 50px>$row12</font></td>";

echo "<td <font size=1 align=right><small style=width: 50px>$row[3]</font></td>";
echo "<td <font size=1 align=right><small style=width: 50px>$row[6]</font></td>";


$tfactura=$tfactura+$row[8];
$samat_ret=$samat_ret+$row[12];

$total_factura=$total_factura+$tfactura;
$total_ret_samat=$total_ret_samat+$samat_ret;
...
$mtotal_ret_samat=number_format($total_ret_samat,2);
}
echo "<tr>";
...
echo "<td <font size=1 align=right><small style=width: 50px><b>$mtotal_ret_samat</b></font></td>";
echo "<td <font size=1 align=left><small style=width: 50px><b>-</b></font></td>";
