...
<tr> 
    <td height="0" colspan="2"><p align="right"><strong><font size="2" face="Times New Roman, Times, serif">CIPEE-COPIA-AT-<? echo $numerosig; ?>-<?echo $ano;?></font></strong></p></td>
  </tr>
</table>
...
<table width="625" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <tr> 
    <td height="0" colspan="2"><p align="center"><strong><font size="5" face="Times New Roman, Times, serif">AUTENTICACIÓN</font></strong></p></td>
  </tr>
</table>
 <td>&nbsp;</td> 
<table width="600" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
    <tr> 
    <td height="0" colspan="2"><p align="justify"  style="font: 14pt/20pt Garamond, Georgia, serif;" ><font size="3" face="Times New Roman, Times, serif">&nbsp;&nbsp;   Quien Suscribe,<strong> <? echo $row2[0]; ?></strong>, Titular de la Cédula de identidad <strong> N. V-9990172</strong>,  <strong><? echo $row2[2]; ?></strong>, autentica que el fondo negro de la Copia Certificada de Título de <strong> <? echo $row[titulo]; ?></strong>, que presenta el ciudadano(a) <strong> <? echo utf8_encode($row[nombre]); ?></strong>,  <? if ($row[nacion]=='E'){ ?> Portador del Pasaporte <?}else{?> Titular de la Cédula de identidad <? }?> N. <strong> <? echo $row[nacion].'-'.$row[cedula]; ?></strong>, se encuentra asentado en el libro de Actas de Grado de esta Casa de Estudios con el Código del título: <strong> <? echo $row[codigo]; ?></strong>, Tomo: <strong> <? echo $row[tomo]; ?></strong>, Fólio: <strong> <? echo $row[folio]; ?></strong>, en la Ciudad de <strong> <? echo $row[ciudad_r]; ?></strong> del Estado <strong> <? echo $row[estado_r]; ?></strong>.<strong><?php ?></strong></font></p></td>
  </tr>
</table>
