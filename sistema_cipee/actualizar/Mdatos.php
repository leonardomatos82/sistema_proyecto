...
<table width="750" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2"><strong>Actualizar Datos del Egresado</strong></td>
  
  </tr>
 
  <tr>
    
    <td><form style="width: 700px; height: 400px;" action="actualizar_r.php"  method="post">
      <p>
      
        <table width="80%" border="0"> <tr>
  <td height="88"><p align="right">&nbsp;</p>
      
    <td width="300"><em>Actualice los Datos del Egresado y haga clic en ACTUALIZAR REGISTRO:</em></td>
 
  </tr>
 <tr> 
            <td width="30%"><div align="left">ID:</div></td>
            <td width="70%"><input  name="id" type="text" id="id" readonly size="3" value="<? echo $row['id_solicitud'];?>"></td>
          </tr>
<tr> 
 ...
 <option value="TECNICO SUPERIOR UNIVERSITARIO EN ENFERMERIA">TECNICO SUPERIOR UNIVERSITARIO EN ENFERMERIA</option>
		...
		<option value="TECNICO SUPERIOR UNIVERSITARIO EN INFORMATICA PARA LA GESTION SOCIAL" >TECNICO SUPERIOR UNIVERSITARIO EN INFORMATICA PARA LA GESTION SOCIAL</option>
          ...
          <tr> 
            ...
            <td width="70%"><input  name="nombre" type="text" id="id"  size="60" value="<? echo $row['nombre'];?>"></td>
          </tr>

 <tr> 
            <td width="30%"><div align="left">CEDULA:</div></td>
            <td width="70%"><select name="nacionalidad" id="nacionalidad" >
                <option value="<? echo $row['nacion'];?>" ><? echo $row['nacion'];?></option>
                <option value="V" selected>V</option>
              <option value="E">E</option>
		</option>
              
              </select><input name="cedula" type="text" id="cedula"  value="<? echo $row['cedula'];?>"size="15" value=""></td>
          </tr>
 <tr> 
            <td width="30%"><div align="left">CODIGO N:</div></td>
            <td width="70%"><input  name="codigo" type="text" id="codigo"  size="5" value="<? echo $row['codigo'];?>">Tomo<input  name="tomo" type="text" id="tomo"  size="5" value="<? echo $row['tomo'];?>">Folio<input  name="folio" type="text" id="folio"  size="5" value="<? echo $row['folio'];?>"></td>
          </tr>
...
<option value="DEPENDENCIAS FEDERALES 1" >DEPENDENCIAS FEDERALES 1</option>
          ...
          <td width="30%"><div align="left"></div></td>
            <td><input value="Actualizar Registro" type="submit" name="submit2"></td>
          </tr>
        </table>
      <p>
</p>
