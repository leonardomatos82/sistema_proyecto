...
<table width="760" border="0" align="center" bgcolor="#FFFFFF">
  <tr> 
    <td colspan="2"><strong>Seguro que desea eliminar el Material o Suministro</strong></td>
    <td width="73">&nbsp;</td>
  </tr>
  <tr> 
    <td width="60">&nbsp;</td>
    <td width="709"><em>Eliminar material o suministro:</em></td>
    <td>&nbsp;</td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
  ...
  <tr> 
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="post" action="elim_material.php">
        <table width="98%" height="150" border="0" cellpadding="2" cellspacing="0">
          ...
          <td ></td>
            <td width="10%"><div align="left"><strong> 
                <input value="ELIMINAR MATERIAL DEL INVENTARIO" type="submit" name="submit2" />
                </strong></div></td>
          </tr>
        </table>
        </form></td>
