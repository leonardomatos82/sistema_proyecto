    ...
    <td><table width="100%" height="48" border="0"  align="center" cellpadding="0" cellspacing="1" >
      ...
      <tr>
        <td width="100%" height="42" bordercolor="#000000" bgcolor="#FFFFFF">
            <?php
 $result = pg_query($con,"SELECT Distinct ingreso_material.fecha,ingreso_material.fecha_fact,usuario.nombre,ingreso_material.factura,ingreso_material.monto
...
?>
        ...
        <td><a href="../suministros/ver_ingreso.php?cod=<?=$row[5]?>&amp;titulo=<?="MODIFICAR DESPACHO"?>"><img
