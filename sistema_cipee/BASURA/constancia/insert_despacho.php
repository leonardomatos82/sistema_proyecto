...
<?	  
	    ...
	    $sql1="INSERT INTO orden_pedido (fecha, nombrerazon, direccion, rifci, formapago, total,estado) 
       VALUES ('$fecha','$_POST[v1]','$_POST[v2]','$_POST[v3]','$_POST[v4]','$_POST[total]','$estado')"; 
