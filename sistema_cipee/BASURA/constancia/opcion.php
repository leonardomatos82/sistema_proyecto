...
if ( $_POST['tipo_reporte'] == "01" ) {
 ...
 header("Location: ver_rep_partida.php?desde_dia=$desde_dia&desde_mes=$desde_mes&desde_year=$desde_year&hasta_dia=$hasta_dia&hasta_mes=$hasta_mes&hasta_year=$hasta_year&tipo=$tipo"); 
           // echo "<p>Usted está autorizado</p>";  //todo esta bien
	...
	if ( $_POST['exportar'] == "01" ) {
     	$archivo="XLS";	
       if ( $_POST['tipo_reporte'] == "06" ) {
          header("Location: excel_ret_iva.php?desde_dia=$desde_dia&desde_mes=$desde_mes&desde_year=$desde_year&hasta_dia=$hasta_dia&hasta_mes=$hasta_mes&hasta_year=$hasta_year&tipo=$tipo&archivo=$archivo"); 
