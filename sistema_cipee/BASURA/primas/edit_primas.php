...
$_POST[estudio]=number_format($_POST[estudio],2,',', '.');
//$_POST[bononocturno]=number_format($_POST[bononocturno],2,',', '.');
 $sql = "UPDATE trabajador SET nombre='$_POST[nombre]', cargo='$_POST[cargo]', departamento='$_POST[departamento]', sueldo='$_POST[sueldo]', 
       hijo='$_POST[hijo]', jerarquia='$_POST[jerarquia]', profesionalizacion='$_POST[profesionalizacion]',antiguedad='$_POST[antiguedad]',hogar='$_POST[hogar]',chofer='$_POST[chofer]',moto='$_POST[moto]',integral='$_POST[integral]',hijoe='$_POST[hijoe]',estudio='$_POST[estudio]',bono_nocturno='$_POST[bononocturno]'
	  ...
	  /////////////////////////////
$valor="-Operacion: Modificar Datos Personales -".$_POST[cedula];
