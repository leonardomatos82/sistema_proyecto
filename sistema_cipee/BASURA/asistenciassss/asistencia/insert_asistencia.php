...
<table width="824" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td><form style="width: 615px;" action="menu_asistencia.php";" method="post">
      <p align="left"><br />
          <?php
if($_POST[fecha]=="" || $_POST[nombre]=="" || $_POST[entra1]=="")
		{
	  ...
	  else 
	   {
	    ...
	    $query="SELECT * FROM personal where cedula='$_POST[nombre]'";
     ...
     // echo $row[cedula]; die();
       ...
       $sql="INSERT INTO asistencia(
        ...
        VALUES ('$fecha','$row[id_personal]','$row[cedula]','$row[id_dpto]','$_POST[entra1]'
        ,'$_POST[sale1]','$_POST[entra2]','$_POST[sale2]','$_POST[observacion]')"; 
