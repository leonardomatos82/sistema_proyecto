...
-- Started on 2008-03-06 10:01:55 VET
...
--
-- TOC entry 1303 (class 1259 OID 16386)
-- Dependencies: 1662 5
...
--
-- TOC entry 1304 (class 1259 OID 16389)
-- Dependencies: 5
...
--
-- TOC entry 1305 (class 1259 OID 16391)
-- Dependencies: 1663 5
...
--
-- TOC entry 1306 (class 1259 OID 16397)
-- Dependencies: 5
...
SELECT pg_catalog.setval('cheque_id_cheque_seq', 29, true);


--
-- TOC entry 1307 (class 1259 OID 16399)
-- Dependencies: 1664 5
...
--
-- TOC entry 1308 (class 1259 OID 16402)
-- Dependencies: 5
...
--
-- TOC entry 1309 (class 1259 OID 16404)
-- Dependencies: 1665 5
...
--
-- TOC entry 1310 (class 1259 OID 16407)
-- Dependencies: 5
...
SELECT pg_catalog.setval('distribucion_cheque_id_distribucion_seq', 30, true);


--
-- TOC entry 1311 (class 1259 OID 16409)
-- Dependencies: 1666 5
...
--
-- TOC entry 1312 (class 1259 OID 16415)
-- Dependencies: 5
...
--
-- TOC entry 1313 (class 1259 OID 16417)
-- Dependencies: 5
...
--
-- TOC entry 1327 (class 1259 OID 16463)
-- Dependencies: 5
...
--
-- TOC entry 1314 (class 1259 OID 16419)
-- Dependencies: 1667 5
...
--
-- TOC entry 1315 (class 1259 OID 16422)
-- Dependencies: 5
...
--
-- TOC entry 1316 (class 1259 OID 16424)
-- Dependencies: 1668 5
...
--
-- TOC entry 1317 (class 1259 OID 16427)
-- Dependencies: 5
...
--
-- TOC entry 1318 (class 1259 OID 16429)
-- Dependencies: 1669 5
...
--
-- TOC entry 1319 (class 1259 OID 16432)
-- Dependencies: 5
...
--
-- TOC entry 1320 (class 1259 OID 16434)
-- Dependencies: 1670 5
...
--
-- TOC entry 1321 (class 1259 OID 16440)
-- Dependencies: 5
...
--
-- TOC entry 1322 (class 1259 OID 16442)
-- Dependencies: 1671 5
...
--
-- TOC entry 1323 (class 1259 OID 16448)
-- Dependencies: 5
...
--
-- TOC entry 1328 (class 1259 OID 16468)
-- Dependencies: 1673 5
...
--
-- TOC entry 1329 (class 1259 OID 16474)
-- Dependencies: 5
...
SELECT pg_catalog.setval('tabla_id_tabla_seq', 1, true);


--
-- TOC entry 1324 (class 1259 OID 16450)
-- Dependencies: 5
...
--
-- TOC entry 1325 (class 1259 OID 16455)
-- Dependencies: 1672 5
...
--
-- TOC entry 1326 (class 1259 OID 16461)
-- Dependencies: 5
...
SELECT pg_catalog.setval('usuario_id_usuario_seq', 22, true);


--
-- TOC entry 1331 (class 1259 OID 16491)
-- Dependencies: 1674 5
...
--
-- TOC entry 1330 (class 1259 OID 16487)
-- Dependencies: 5
...
SELECT pg_catalog.setval('viaticos_id_viatico_seq', 1, true);


--
-- TOC entry 1675 (class 0 OID 16386)
-- Dependencies: 1303
...
--
-- TOC entry 1676 (class 0 OID 16391)
-- Dependencies: 1305
...
INSERT INTO cheque (fecha, ncheque, monto_cheque, beneficiario, concepto, programa, cod_contable, id_cheque, estado, motivo, fecha_a, cedula_rif) VALUES ('2008-03-04', '31812438', '260', 'VICTOR NOGUERA', 'CANCELACION QUE SE LE HACE AL CIUDADANO VICTOR NOGUERA TITULAR DE LA C.I. V-9.367.505, CHOFER DE LA COOPERATIVA TRANSPORTE PEDRAZA RL POR CONCEPTO DE TRASLADO DE LOS ESTUDIANTES GRADUANDOS DE LOS PFG GESTION SOCIAL Y GESTION AMBIENTAL DESDE SANTA BARBARA DE BARINAS HASTA SOCOPO Y VICEVERSA SEGUN FACTURA NRO 019408 DE FECHA 04-03-2008. CON CARGO AL FONDO ESPECIAL DE AVANCE POR MOTIVO DE ACTO DE GRADO.', 'COORDINACION DE ADMINISTRACION', 'BNS-024', 28, 'PAGADO', NULL, NULL, 'V-9367505');


--
-- TOC entry 1677 (class 0 OID 16399)
-- Dependencies: 1307
...
--
-- TOC entry 1678 (class 0 OID 16404)
-- Dependencies: 1309
...
INSERT INTO distribucion_cheque (fecha, ncheque, cod_partida, monto, programa, cod_contable, id_distribucion, estado) VALUES ('2008-03-04', '31812438', '31', '260', 'COORDINACION DE ADMINISTRACION', 'BNS-024', 27, 'PAGADO');


--
-- TOC entry 1679 (class 0 OID 16409)
-- Dependencies: 1311
...
--
-- TOC entry 1687 (class 0 OID 16463)
-- Dependencies: 1327
...
--
-- TOC entry 1680 (class 0 OID 16419)
-- Dependencies: 1314
...
--
-- TOC entry 1681 (class 0 OID 16424)
-- Dependencies: 1316
...
--
-- TOC entry 1682 (class 0 OID 16429)
-- Dependencies: 1318
...
--
-- TOC entry 1683 (class 0 OID 16434)
-- Dependencies: 1320
...
--
-- TOC entry 1684 (class 0 OID 16442)
-- Dependencies: 1322
...
--
-- TOC entry 1688 (class 0 OID 16468)
-- Dependencies: 1328
-- Data for Name: tabla; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO tabla (tipo, desayuno, almuerzo, cena, alojamiento, taxi, transporte, tasa, autobus, vehiculo, id_tabla) VALUES ('prueba', 100, 100, 100, 100, 100, 100, 100, 5, 5, 1);


--
-- TOC entry 1685 (class 0 OID 16450)
-- Dependencies: 1324
...
--
-- TOC entry 1686 (class 0 OID 16455)
-- Dependencies: 1325
...
--
-- TOC entry 1689 (class 0 OID 16491)
-- Dependencies: 1331
...
-- Completed on 2008-03-06 10:01:55 VET
