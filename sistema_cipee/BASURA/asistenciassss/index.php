...
<!--? Main -->
<table width="767" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  <tr>
 ...
 <form name="form2" method="post" action="control/login.php?time=<?=$time ?>">
          ...
          <p align="center"><img src="imagenes/lector.jpg" alt="" width="70" height="50" /> </p>
           ...
           <hr class="noscreen" />
          <p align="center"> <FONT Size=1> <a href="index2.php"> <font size="2">SESION DE COORDINADOR</font></a> </p>
