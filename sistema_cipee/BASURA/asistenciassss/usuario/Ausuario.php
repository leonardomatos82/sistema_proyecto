      ...
      <p>
        ...
        <table width="81%" border="0">
          <tr> 
            ...
            <td width="83%"><input name="cedula_rif" type="text" id="cedula_rif" onKeyPress="return acceptNum(event)" autocomplete=OFF maxlength=8 size="10" value="">
              *sin puntos</td>
          </tr>
          <tr> 
            <td width="17%"><div align="left">Nombres</div></td>
            <td width="83%"><input name="nomb_usuario" &gt="" type="text"  autocomplete=OFF size="45">
              *</td>
          </tr>
             <tr> 
