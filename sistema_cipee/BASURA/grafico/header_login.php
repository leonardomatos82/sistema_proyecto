...
<body leftmargin=0  topmargin=0  marginwidth=0  marginheight=0 bgcolor=#9a9a9a  onload='this.document.form_registrados.login.focus();'>
<table align=center style='border:1px solid #9a9a9a'  bgcolor=#ffffff cellpadding=0 cellspacing=0  width=770 height=100%>
<tr><td height=60><img src=images/banner2_login.jpg></td></tr>
<tr><td height=15>";
include('barra_ppl.php');
echo"</td></tr>
<tr><td valign=top>";
?>
