...
<table width="750" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2"><strong><font size="1">Emitir reporte por rango de fecha </strong></td>
 
  </tr>
  <tr>
   
    <td width><em><font size="1">Seleccione el rango de fecha que desea buscar y haga clic en <strong>Consultar</strong> :</em></td>
  
  </tr>
 
  <tr>
 
    <td><form style="width: 342px; height: 200px;" action="tipo_reporte.php" method="post">
      <table   border="0" >
  <tr> <tr> 
