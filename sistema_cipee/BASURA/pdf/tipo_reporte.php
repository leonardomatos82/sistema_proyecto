...
///////////////////////////////////////////////////////////////////   
              ...
              header("Location: ../pdf/rep_solicitud_constancia_pdf.php?desde_dia=$desde_dia&desde_mes=$desde_mes&desde_year=$desde_year&hasta_dia=$hasta_dia&hasta_mes=$hasta_mes&hasta_year=$hasta_year"); 
