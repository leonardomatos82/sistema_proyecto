...
<table width="750" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2"><font size=1>SOLICITUD DE CONSTANCIAS DE TRABAJO PROCESADAS</td>
   <td width="200">&nbsp;</td>
  </tr>
  <tr>
    <td width="149">&nbsp;</td>
  ...
  <tr>
    ...
    <p align="right">&nbsp;</p></td>
    <td><table width="100%" height="38" border="0"  align="center" cellpadding="0" cellspacing="1" >
      <tbody>
      </tbody>
      <tr>
        <td width="100%" height="42" bordercolor="#000000" bgcolor="#FFFFFF"><?php
$sql="select * from solicitud where estado='PROCESADO'
...
echo "<tr>";
echo "<td <small style=width: 50px font-weight: bold><b><font size=1>NUM</b></td>";
...
echo "<tr> ";
$cont++;
echo "<td <small style=width: 100px ><font size=1>$row[0]</td> ";
