...
$row = 1;
$handle = fopen("GARANTIA.csv", "r"); //Coloca el nombre de tu archivo .csv que contiene los datos
while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
    ...
    $row++;
    $cadena = "INSERT INTO GARANTIA (cod_credito,descripcion_garantia) Values ("; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
