...
<table width="750" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2"><strong>Eliminar Rubro</strong></td>
    <td width="77">&nbsp;</td>
  </tr>
  <tr>
    <td width="149">&nbsp;</td>
    <td width="584"><em>Seguro que desea Eliminar los datos del Rubro:</em></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="88"><p align="right">&nbsp;</p>
        <p align="right">&nbsp;</p></td>
    <td><form id="form1" name="form1" method="post" action="elim_rubros.php">
      <table width="70%" height="146" border="0">
        ...
        <tr>
          ...
          <td width="77%"> <input name="descripcion_rubro" readonly  type="text" value= "<?php echo $row[descripcion_rubro]; ?>">*&nbsp;</td>
        </tr>
       <tr bordercolor="#000000" bgcolor="#FFFFFF"> 
            <td height="23">Tipo Credito:</td>
            <td><select readonly name="id_creditos" id="id_creditos">
