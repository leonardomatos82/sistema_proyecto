...
<body onLoad="Barva('#000000')">


<form name="hcc" id="hcc">	

<table border="1" cellspacing="0" cellpadding="0" align="center" style="border-collapse:collapse;" bordercolor="#CCCCCC"><tr><td>
<table width="375" border="0" cellspacing="1" cellpadding="0" align="center">
	...
	<tr height="25">
		<td id="vzorec" width="25"></td>
		<td valign="bottom"><p>Codigo hexadecimal: <input type="text" name="barva" id="barva" style="font-family:Verdana;height:30px; width:115px; font-size:22px" maxlength="7" size="9" /></p></td>
	</tr>
