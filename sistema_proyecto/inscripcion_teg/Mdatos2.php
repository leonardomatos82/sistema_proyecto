...
<tr><td>
<font size="-1">* Parroquia:</font>
<input  name="comunidad_parroquia" type="text" id="id"  size="10" value="" onkeyup="return acceptChar(event)" onkeypress="return acceptChar(event)">
<font size="-1">* Municipio:</font>
...
<input  name="enlace" type="text" id="id"  size="18" value="" onkeypress="return acceptChar(event)">
...
<input  name="academico" type="text" id="id"  size="18" value="" onkeypress="return acceptChar(event)">
<font size="-1">* Correo:</font>
<input  name="correo_academico" type="text" id="id"  size="18" value="@">
<font size="-1">* Telefono:</font>
<input  name="tlf_academico" type="text" id="id"  size="8" value="" onkeypress="return acceptNum(event)">
