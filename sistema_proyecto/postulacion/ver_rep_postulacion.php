...
<table width="700" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <tr> 
    <td height="0" colspan="2"><p align="center"><strong><font size="5" face="Times New Roman, Times, serif">CONSTANCIA DE CUMPLIMIENTO DEL SERVICIO COMUNITARIO</font></strong></p></td>
...
<font size="3"><em>&nbsp;&nbsp;&nbsp;&nbsp;POR MEDIO DE LA PRESENTE SE CERTIFICA QUE EL(LA) BACHILLER: <strong><? echo $row[nombre]; ?></strong>, TITULAR DE LA CEDULA DE IDENTIDAD N. <strong><? echo $row[cedula]; ?></strong>, ESTUDIANTE REGULAR DEL PROGRAMA DE FORMACION DE GRADO: <strong><? echo $row3[pfg]; ?></strong>, DURANTE EL PERIODO ACADEMICO <strong><? echo $rowpl[periodo] ; ?></strong>, CULMINO Y APROBO SATISFACTORIAMENTE LA PRESTACION DEL SERVICIO COMUNITARIO DENOMINADO: <strong><? echo $row2[teg]; ?></strong> EN LA COMUNIDAD:  <? echo $row2[comunidad]; ?>, PARROQUIA:  <? echo $row2[parroquia]; ?>, MUNICIPIO:  <? echo $row2[municipio]; ?>, ESTADO:  <? echo $row2[estado]; ?> 
...
<tr> 
    <td align="center">
    <font size="2"><strong><em>COORDINADOR DE ALDEA</em></strong>
   </td>
<td align="center">
