...
<table width="750" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2"><strong><font size="1">Generar Relacion de TEG Inscritos </strong></td>
  ...
  <tr>
    ...
    <td><form style="width: 342px; height: 200px;" action="rep_inscripcion_teg_pdf.php" method="post">
      <table   border="0" width="700">
  <tr><td>&nbsp;</td><td></td></tr>
          
        <tr>
          <td width="15%" height="30"><font size="2">PFG: </td>
