...
<table width="700" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <tr> 
    <td height="0" colspan="2"><p align="center"><strong><font size="4" face="Times New Roman, Times, serif">COMPROBANTE DE CONSIGNACIÓN DE RECAUDOS PARA TEG</font></strong></p></td>
  </tr>
...
<tr> 
  ...
  <tr> 
    ...
    <td><font size="1">Una (01) Trabajo Especial de grado en Físico y/o Digital</font></td>
    <td><font size="1"><? if ($row2[documento1]=='on'){ echo ' SI '; }else{ echo ' NO '; } ?></font></td>
  </tr>
    <tr> 
      <td><font size="1">02</font></td>
    <td><font size="1">Una (01) copia ampliada de la cedula de identidad o pasaporte sin recortar</font></td>
    <td><font size="1"><? if ($row2[documento2]=='on'){ echo ' SI '; }else{ echo ' NO ';} ?></font></td>
  </tr>
    <tr> 
    ...
    <td><font size="1"><? if ($row2[documento3]=='on'){ echo ' SI '; }else{ echo ' NO ';} ?></font></td>
  </tr>
    <tr> 
      <td><font size="1">04</font></td>
    <td><font size="1">Una (01) copia de la planilla de inscripción emitida por SUR@UBV</font></td>
    <td><font size="1"><? if ($row2[documento4]=='on'){ echo ' SI '; }else{ echo ' NO '; } ?></font></td>
  </tr>
...
<tr> 
    <td>
    <font size="2"><strong><em>FECHA: <? echo $row2[fecha_inscripcion]; ?></em></strong>
   </td>   <td align="center">
...
<?
	  /////////////////////////////
$valor="-Operacion: IMPRIMIR COMPROBANTE DE TEG-".$cedula;
