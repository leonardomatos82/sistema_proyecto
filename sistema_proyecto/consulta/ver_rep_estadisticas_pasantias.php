...
include("numero2.php"); 
$cedula=$_GET[id];
$result1 = pg_query($con, "select count(id_pasantia) from pasantia where periodo='$_POST[periodo]'"); 
...
<table width="625" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <tr> 
    <td height="0" colspan="2"><p align="center"><strong><font size="5" face="Times New Roman, Times, serif">ESTADISTICAS DE INSCRIPCION DE PASANTIAS <? echo $_POST[periodo];?></font></strong></p></td>
  </tr>
</table>
 <td>&nbsp;</td> 
...
$c=1;
for($i=1;$i<=$l;$i++){
$result = pg_query($con, "select count(id_pasantia) from pasantia where pfg='".$array[$i]."' and periodo='$periodo'"); 
...
for($i=0;$i<2;$i++){
$result = pg_query($con, "select count(id_pasantia) from pasantia where estado='".$array[$i]."' and periodo='$periodo'"); 
$row=pg_fetch_array($result);
...
<?
	  /////////////////////////////
$valor="-Operacion: IMPRIMIR ESTADISTICA DE INSCRIPCION DE PASANTIAS-".$cedula;
